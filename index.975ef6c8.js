...
let timerId = null;
window.onscroll = (0, _lodashThrottleDefault.default)(onScroll, 500);
...
function onScroll() {
    ...
    if (window.scrollY > 700) sttButton.classList.remove("stt-button--hidden");
    else if (window.scrollY > 600 && window.scrollY < 700) hideButton();
